-- ============================================================================
-- MIGRATION 008: Supabase pg_cron Setup
-- Date: 2025-01-20
...
-- ============================================================================
-- 5. SCHEDULE CRON JOBS (ONLY IF NOT ALREADY SCHEDULED)
-- ============================================================================

-- Remove existing jobs if they exist
SELECT cron.unschedule('ai-evaluation-processing');
SELECT cron.unschedule('role-promotion-check');
SELECT cron.unschedule('system-log-cleanup');
