-- ============================================================================
-- Supabase pg_cron Setup - Execute in Supabase SQL Editor AFTER ai_evaluation_setup.sql
-- Date: 2025-01-20
...
DO $$
BEGIN
    PERFORM cron.unschedule('ai-evaluation-processing');
    PERFORM cron.unschedule('role-promotion-check');
    PERFORM cron.unschedule('system-log-cleanup');
EXCEPTION WHEN OTHERS THEN
